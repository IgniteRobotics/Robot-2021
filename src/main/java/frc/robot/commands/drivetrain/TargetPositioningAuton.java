...
public class TargetPositioningAuton extends CommandBase {
     ...
     */
    public TargetPositioningAuton(RamseteDriveSubsystem driveTrain, Joystick driveController ) {
        addRequirements(driveTrain);
        this.m_driveTrain = driveTrain;
        this.driverJoystick = driveController;
        // Use addRequirements() here to declare subsystem dependencies.

        tab = Shuffleboard.getTab("Limelight Auton");
